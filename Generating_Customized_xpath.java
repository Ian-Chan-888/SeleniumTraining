...
public class Generating_Customized_xpath {

	public static void main(String[] args) {

		// This lesson is to generate custom xpath from html attributes. When looking at
		// a html: for the example in line 12.
		...
		// for the following html line "<input value="Log In" aria-label="Log In"
		...
		// One can also define an attribute value without knowing the full name of the
		// value by using the 'contains' syntax. format should be
		...
		try {
			...
			String ContactusXP = "/html/body/header/div[2]/div[3]/div/div/nav/div[1]/div/div[3]/div[1]/div[3]/a";// "Contact
																													// Us"
			// .. when xpath starts with "//html.." then switch browser and find element
			// again. "//*id..." is better.
			...
			driver.findElement(
					By.xpath("/html/body/header/div[2]/div[3]/div/div/nav/div[1]/div/div[3]/div[1]/div[3]/ul/li[3]/a"))
					.click();
		...
		// get error message when no password it selected - then display error message
		// in console.
