...
public class S14_Lesson109_110_Table_columns_Sorting_Strategy_plan {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		 ...
		 *
		 * 1. retrive all values of veg/fruit name coloumn - create: A. originalList-
		 * :3124 B. copiedList- 3124 sort using the 'collections.' framework :1234
		 * 
		 * C. ArrayList2- sorted ________________________________________ | # |
		 * Veg/fruit name | Price| Discount | |---|----------------|------|----------| |
		 * 1 | Apple | 230 | 200 | | 2 | Carrot | 36 | 25 | | 3 | Orange | 43 | 40 | | 4
		 * | Potato | 20 | 10 | | 5 | Tomato | 30 | 15 | | 6 | Mango | 95 | 66 |
		 * ----------------------------------------
		 * 
		 */
		...
		for (int i = 0; i < originalList.size(); i++) {
			copiedList.add(originalList.get(i)); // copy each value from the original list and place it into the
													// copiedList

		}

		Collections.sort(copiedList); // sorts the copiedList
		...
		Assert.assertTrue(originalList.equals(copiedList)); // Throws exception if originalList is not equal to the
															// copiedList

		/*
		 * 
		 * 
		 * NOTE: AT THIS POINT WE KNOW WITH LINE 106 YOU THIS WILL FAIL AS BOTH TABLES
		 * BY DEFAULT ARE NOT THE SAME.
		 * 
		 */
