...
public class S14_Lesson109_110_Table_columns_Sorting_Strategy_plan {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		 ...
		 *  A. originalList-
		 *    :3124
		 *  B. copiedList- 3124 sort using the 'collections.' framework
		 *    :1234
		 *    
		 *  C. ArrayList2- sorted
	...
	//B. copy the original list and sort
		 ...
		 * 
		 * 
		 * NOTE: AT THIS POINT WE KNOW WITH LINE 106 YOU THIS WILL FAIL AS BOTH TABLES BY DEFAULT ARE NOT THE SAME. 
		 * 
		 */
