...
public class S08_Lession50_Parent_Child_relationships_locator_to_Idenify_the_objects_Uniquely {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Note: I was getting element not interactable when the window is a smaller size. I noticed that the drop down menu style changes when it is small in size vs max windows size.
		...
		//	// a[@value='BLR']
			...
			*/
			...
			// Before we used this with "indexes" to define the element    ---->    driver.findElement(By.xpath("(//a[@value='MAA'])[2]")).click();  
			/* below is another way of looking at this without using indexes "[2]"
			 * 
			 *  //div[@id='glsctl00_mainContent_ddl_destinationStation1_CTNR']  --- is parent xpath
			 *  
			 ...
			 * below (line 47) you will see a example of syntax for finding elements using the Parent child relationships. 
			 */
