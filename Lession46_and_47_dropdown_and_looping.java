...
public class Lession46_and_47_dropdown_and_looping {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/* Similarly you can use the following: 
			s.selectByIndex(2); //selects the second entry in the drop-down "AED"
			s.selectByVisibleText("INR");//selects the INR currency
		*/
...
// Example of Dynamic drop-down + use of loops
			...
			System.out.println(driver.findElement(By.id("divpaxinfo")).getText());//print out the value chosen in the "Passengers" field  = '2 Adult'
...
//Another loop you can use is the for loop, In here you define all the parameters within the loop at the beginning. Example below chooses 5 Adults
							...
							for(int Adults=1;Adults<4;Adults++) // the loop stops at 4 clicks = 5 Adults.  Note if you run this code you will wind up with 9 adults because the first loop leaves the value set at 6
								{
									driver.findElement(By.id("hrefIncAdt")).click();// Incrementing adult button
								}
		...
		System.out.println(driver.findElement(By.id("divpaxinfo")).getText());//print out the value chosen in the "Passengers" field = '9 Adult'
