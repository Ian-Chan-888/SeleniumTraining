...
public class S12_Lesson93_94_95_96_Handling_calendar_UI_In_Travel_websites {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		 * Calendars in travel websites or simular, often will not have a unique identifier for the days. 
		 * 
		 * 1. Lets target elements in the month and the day
		 *  -Grab the common attribute and put into a list. Then iterate until the target day is found.
		 *  -While loop will keep on executing until it becomes false. By using the '!' = Not
		 */
		...
		driver.findElement(By.xpath("//input[@id='travel_date']")).click(); //open the Date window
				...
				while(!driver.findElement(By.cssSelector("[class='datepicker-days'] [class='datepicker-switch']")).getText().contains("December")) //while NOT '!' Month then...
					{
					Thread.sleep(2000);	
					driver.findElement(By.cssSelector("[class='datepicker-days'] [class='next']")).click();  //click on the next arrow
					}
