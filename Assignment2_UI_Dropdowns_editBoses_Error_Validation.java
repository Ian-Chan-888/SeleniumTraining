...
public class Assignment2_UI_Dropdowns_editBoses_Error_Validation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		 * 1. Select Adults and Childern elements
		 * 2. Select the Deaprt On Calendar and select todays date.(default date)
		 * 3. Click on the "More Options link and enter any "Perferred Airline values"  = IndiGo (6E)
		 * 4. With NO items populated in the "From" or "To" field, Optain an error message after clicking the
		 * "Get Flights" button. 
		 */
