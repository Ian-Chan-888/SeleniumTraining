...
public class S15_Lesson116_DesiredCapabilities_and_RemoteWebdriver_importance {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		 ...
		 * 
		 * import org.openqa.selenium.remote.DesiredCapabilities; - helps set the
		...
		/*
		 * where you would use Webdriver driver = new Chromedriver(); you use: WebDriver
		 * driver = new RemoteWebDriver(new URL (<address>),dc);
		 * 
		 * you need to add: import org.openqa.selenium.remote.RemoteWebDriver; import
		 * java.net.URL
		 * 
		 */
