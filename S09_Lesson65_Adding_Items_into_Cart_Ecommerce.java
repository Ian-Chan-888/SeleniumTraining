...
public class S09_Lesson65_Adding_Items_into_Cart_Ecommerce {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		String[] itemsNeeded = { "Brocolli", "Beetroot", "Cauliflower" }; // we are defining an array of strings in by
		...
		/*
		 * Lets Add Items to cart and run some validations Problem is that there are
		 * several elements labled "Add to Cart" How do we know which "Add to Cart" to
		 * click? By Looping to each product name and finding the correct name then
		 * click on the 'Add to Cart" for that index.
		 * 
		 */

		// Example 1: Adding Cucumber into cart. Identifying the Cucumber index and then
		// clicking on the add to cart button within that index
		List<WebElement> products = driver.findElements(By.cssSelector("h4.product-name")); // find all the elements
		...
		// Example 2: Adding multiple products. Note that we Variablized an Array in
		// Line 19 above. (Lesson 67)
