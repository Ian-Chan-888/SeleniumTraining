...
public class S11_Lesson80_81_Handling_Ajax_Mouse_interactions {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		 ...
		 * Performing Mouse and keyboard interations with Selenium
		 * Context click on element
		 * Double click on element
		 * Drag and ropping the element
		 * 
		 *
		 * 
		 * Lession 80 = intro
		 * lession 81 - Action class - real time example (composite actions)
		 * 
		 *
		 * 
		 */
		...
		a.moveToElement(move)
			.contextClick() //right clicks on element
