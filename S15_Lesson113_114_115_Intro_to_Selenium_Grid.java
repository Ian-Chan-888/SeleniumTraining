...
public class S15_Lesson113_114_115_Intro_to_Selenium_Grid {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		 ...
		 *       - then invoke the jar by typing : 'java -jar selenium-server-standalone-3.141.59.jar - role node -hub 192.168.1.188:4444/grid/register/ -port 5566'
		 *     output: 
		 *     		C:\Selenium>java -jar selenium-server-standalone-3.141.59.jar -role node -hub http://192.168.1.188:4444/grid/register/ -port 5566
		 ...
		 *           java -Dwebdriver.chrome.driver=C:\Selenium\chromedriver.exe -jar selenium-server-standalone-3.141.59.jar -role node -hub http://192.168.1.188:4444/grid/register/ -port 5566
		 *      output: 
		 *      	C:\Selenium>java -Dwebdriver.chrome.driver=C:\Selenium\chromedriver.exe -jar selenium-server-standalone-3.141.59.jar -role node -hub http://192.168.1.188:4444/grid/register/ -port 5566
