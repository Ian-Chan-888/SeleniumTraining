...
public class Assignment7_Web_Tables_S13 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		/*
		 * In this Assignment : Navigate to QAclickAcademy / practice 1. Go to the Web
		 * Table Example - Print the number of rows present (Expected Result = 11 rows)
		 * - Print the number of columns (Expected Result = 3 columns) 2. Print the
		 * second row of data. (Expected Result = Rahul Shetty, Learn SQL in Practical +
		 * Database Testing from Scratch, 25)
		 * 
		 * 
		 * 
