...
public class Assignment3_Wait_S10 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		/*
		 * In This Assignment using Explicit wait you click on the
		 * "Click to load get data via Ajax!" link Validate the text message that
		 * appears when it is displayed.
		 */
