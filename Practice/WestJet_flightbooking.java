...
public class WestJet_flightbooking {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Navigate Month
		while (!driver.findElement(By.cssSelector("span[class='dw-cal-month']")).getText().contains("November")) {
			Thread.sleep(2000);
		...
		int count = driver.findElements(By.cssSelector("div[class='dw-cal-day-fg']")).size();// This counts the number
																								// of elements found

		for (int i = 0; i < count; i++) {

			String text;
			// To prevent stale emlement exception Line 95-100 using try catch with
			// StaleElementReferenceException reference
			try {
		...
		sdate = driver
				.findElement(By.xpath("//*[@id=\"main\"]/div[4]/div[1]/div/div/div[1]/div[2]/div/span/strong/span"))
				.getText();
		...
		Adults = driver
				.findElement(By.xpath("//*[@id=\"main\"]/div[4]/div[1]/div/div/div[1]/div[3]/div/span[1]/strong"))
				.getText();
		...
		Children = driver
				.findElement(By.xpath("//*[@id=\"main\"]/div[4]/div[1]/div/div/div[1]/div[3]/div/span[2]/strong"))
				.getText();
