	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		int countiFrames= driver.findElements(By.tagName("iframe")).size();	
			...
			for(int i=0;i<countiFrames;i++) // there is a problem here as it is not parsing to the next iframe.
			{
				...
				System.out.println("iFrame "+ i + " src is - " + driver.findElement(By.tagName("iframe")).getAttribute("src"));
				System.out.println("iFrame "+ i + " id is - " + driver.findElement(By.tagName("iframe")).getAttribute("id"));
				System.out.println("iFrame "+ i + " location is - " + driver.findElement(By.tagName("iframe")).getLocation());
			}
			...
			int countFrames= driver.findElements(By.tagName("frame")).size();	
				...
				for(int i=0;i<countFrames;i++) // there is a problem here as it is not parsing to the next iframe.
				{
					...
					System.out.println("Frame "+ i + " src is - " + driver.findElement(By.tagName("frame")).getAttribute("src"));
					System.out.println("Frame "+ i + " id is - " + driver.findElement(By.tagName("frame")).getAttribute("id"));
					System.out.println("Frame "+ i + " location is - " + driver.findElement(By.tagName("frame")).getLocation());
				}
