...
public class Assignment5_Frames_S11 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		/* from Lesson 87: Interview Questions: 
		 ...
		 * 3. Print the Middle text in nested frame with the next window
		 * 
		 * 
		 * 
		 */
		...
		System.out.println("The text in the Middle frame is '" + driver.findElement(By.cssSelector("#content")).getText()+"'");  
